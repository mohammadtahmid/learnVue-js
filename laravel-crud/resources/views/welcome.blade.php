...
<body class="">
    ...
    <div class="container">
        <div class="flex justify-between pt-5">
            <h2 class="bg-success p-2 rounded">Home</h2>
            <a class="btn btn-success" href="/create">New Add Post</a>
        </div>
        @if (session('success'))
        ...
        <table class="table mt-5 p-5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img class="rounded-pill" style="width: 80px;" src="images/{{$post->image}}" alt=""></td>
                    <td>
                        <a href="{{route('edit',$post->id)}}" class="btn btn-info" type="btn">Edit</a>
                        <a href="{{route('delete', $post->id)}}" class="btn btn-danger" type="btn">Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
